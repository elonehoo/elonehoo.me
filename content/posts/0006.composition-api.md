...
<!-- ![极简的交互稿](/posts/0006.composition-api/easy-interaction.png) -->

需求较为简单，就是一个搜索结果页面，带有搜索框和多个类别的搜索结果，先按上述的 Container/Presentational 模式拆分一下组件，可得如下组件：

<!-- ![组件的拆分稿](/posts/0006.composition-api/component-split.png) -->
...
![最终实现](/posts/0006.composition-api/finally-realized.png)
