...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" data-src="https://cdn.hugeicons.com/icons/arrow-right-04-stroke-rounded.svg" xmlns:xlink="http://www.w3.org/1999/xlink" role="img">
    <path d="M14 12L4 12" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" />
