...
defineOptions({
  name: 'Theme.Icones.RSS',
})
</script>

<template>
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" class="injected-svg" data-src="https://cdn.hugeicons.com/icons/rss-stroke-rounded.svg" xmlns:xlink="http://www.w3.org/1999/xlink" role="img" color="currentColor">
    ...
    <path d="M2.98242 19.5H2.9914" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
