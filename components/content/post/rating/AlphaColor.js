export default class AlphaColor {
  ...
  parseAlphaHex() {
    return {
      ...
      opacity: this.color.length === 5 ? (Number.parseInt(this.color.substring(4, 5) + this.color.substring(4, 5), 16) / 255).toFixed(2) : (Number.parseInt(this.color.substring(7, 9), 16) / 255).toFixed(2),
