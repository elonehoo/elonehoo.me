...
<template>
  <div class="vue-star-rating" :class="[{ 'vue-star-rating-rtl': rtl }, { 'vue-star-rating-inline': inline }]">
    <div class="sr-only">
      <slot
        name="screen-reader"
    ...
    >
      <span
        ...
        :key="n"
        class="vue-star-rating-star" :class="[{ 'vue-star-rating-pointer': !readOnly }]"
      ...
      <span
        v-if="showRating"
        class="vue-star-rating-rating-text" :class="[textClass]"
