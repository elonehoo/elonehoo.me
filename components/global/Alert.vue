...
<style>
:root {
  --alert-color-note: #0969da;
  --alert-color-tip: #1a7f37;
  --alert-color-warning: #9a6700;
  --alert-color-severe: #bc4c00;
  --alert-color-caution: #d1242f;
  --alert-color-important: #8250df;
}
.dark {
  --alert-color-note: #2f81f7;
  --alert-color-tip: #3fb950;
  --alert-color-warning: #d29922;
  --alert-color-severe: #db6d28;
  --alert-color-caution: #f85149;
  --alert-color-important: #a371f7;
}
