...
<template>
  <CraftBox>
    <div
      class="fistbump w-10 h-10 [transform:scale(2)] [transition:all_0.2s_ease] cursor-pointer pt-[3px] pb-[9px] px-1.5 rounded-[999px] scale-[2] [background:#EDEFEB] hover:[background:#e8eae5]"
      :class="[action ? 'boom' : '']"
